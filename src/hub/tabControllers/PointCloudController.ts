      ...
      [
        {
          ...
          options: [
            PointCloudController.POSE_3D_TYPES, // NumberArray
            PointCloudController.POSE_3D_TYPES.filter((x) => !x.endsWith("ID") && x !== "Trajectory"), // Pose3d
            PointCloudController.POSE_3D_TYPES.filter((x) => !x.endsWith("ID") && x !== "Camera Override"), // Pose3d[]
            PointCloudController.POSE_3D_TYPES.filter((x) => !x.endsWith("ID") && x !== "Trajectory"), // Transform3d
            PointCloudController.POSE_3D_TYPES.filter((x) => !x.endsWith("ID") && x !== "Camera Override"), // Transform3d[]
            ["Vision Target"], // Translation3d
            ["Trajectory", "Vision Target"], // Translation3d[]
            PointCloudController.APRIL_TAG_TYPES, // AprilTag
            PointCloudController.APRIL_TAG_TYPES // AprilTag[]
          ]
        },
        {
          ...
          options: [
            PointCloudController.POSE_2D_TYPES, // NumberArray
            PointCloudController.POSE_2D_TYPES.filter((x) => x !== "Trajectory"), // Pose2d
            PointCloudController.POSE_2D_TYPES, // Pose2d[]
            PointCloudController.POSE_2D_TYPES.filter((x) => x !== "Trajectory"), // Transform2d
            PointCloudController.POSE_2D_TYPES, // Transform2d[]
