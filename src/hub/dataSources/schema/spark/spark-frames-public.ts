...
export const sparkFramesSpec = {
    ...
    periodicFrames: {
        LEGACY_STATUS_0: {
            ...
            signals: {
                APPLIED_OUTPUT: {
                    ...
                    name: "Applied Output",
                    description:
                        "Always 0 so that SPARKs running old firmware trying to follow this SPARK don't move.",
                    bitPosition: 0,
                    isBigEndian: false,
                    lengthBits: 16,
                ...
                FAULTS_AND_STICKY_FAULTS: {
                    ...
                    description:
                        "Always has all faults set so that old software knows that something is wrong.",
                    bitPosition: 16,
                    isBigEndian: false,
                    lengthBits: 32,
                    decodeScaleFactor: BigNumber("1"),
        ...
        STATUS_4: {
            name: "Status 4",
            description:
                "Includes data from the External Encoder (on SPARK MAX, this is the Alternate Encoder).",
            apiClass: 46,
            apiIndex: 4,
            arbId: 33929472,
            lengthBytes: 8,
        ...
        STATUS_6: {
            ...
            signals: {
                UNADJUSTED_DUTY_CYCLE: {
                    ...
                    description:
                        "The duty cycle from 0 to 1, with no inversion or conversion factor applied.",
                    bitPosition: 0,
                    isBigEndian: false,
                    lengthBits: 16,
    ...
    nonPeriodicFrames: {
        ...
        DUTY_CYCLE_SETPOINT: {
            ...
            description:
                "Sets the Control Type to Duty Cycle and sets the target duty cycle (from -1 to 1).",
            apiClass: 0,
            apiIndex: 2,
            arbId: 33882240,
            lengthBytes: 8,
        ...
        SET_STATUSES_ENABLED: {
            ...
            description:
                "Enable or disable status frames. In response, a Set Statuses Enabled Response frame will be sent.",
            apiClass: 1,
            apiIndex: 0,
            arbId: 33883136,
            lengthBytes: 4,
        ...
        SET_STATUSES_ENABLED_RESPONSE: {
            ...
            signals: {
                RESULT_CODE: {
                    ...
                    name: "Result Code",
                    description:
                        "0 on success, 1 if any non-existent or unavailable frames were specified to be enabled",
                    bitPosition: 0,
                    isBigEndian: false,
                    lengthBits: 8,
                    decodeScaleFactor: BigNumber("1"),
                ...
                SPECIFIED_MASK: {
                    ...
                    name: "Specified Mask",
                    description:
                        "Contains the mask specified in the Set Statuses Enabled command that triggered this response.",
                    bitPosition: 8,
                    isBigEndian: false,
                    lengthBits: 16,
                    decodeScaleFactor: BigNumber("1"),
        ...
        NACK: {
            name: "Nack",
            description:
                "As of SPARK MAX firmware 1.6.3, this is only used as a potential response to setting the CAN ID.",
            apiClass: 8,
            apiIndex: 0,
            arbId: 33890304,
            lengthBytes: 0,
        ...
        SWDL_DATA: {
            name: "SWDL Data",
            description:
                "Broadcast from the host to all SPARKs in SWDL mode, containing a slice of firmware data.",
            apiClass: 9,
            apiIndex: 12,
            arbId: 33892096,
            lengthBytes: 8,
        ...
        USB_ONLY_ENTER_DFU_BOOTLOADER: {
            ...
            description:
                "Causes the device to reboot into the DFU bootloader if this command is received directly via USB.",
            apiClass: 11,
            apiIndex: 4,
            arbId: 33893632,
            lengthBytes: 2,
        ...
        GET_MOTOR_INTERFACE: {
            ...
            signals: {
                MOTOR_INTERFACE: {
                    ...
                    description:
                        "0: None, 1: SPARK Flex Dock / SPARK MAX, 2: SPARK Flex standard motor interface",
                    bitPosition: 0,
                    isBigEndian: false,
                    lengthBits: 16,
                    decodeScaleFactor: BigNumber("1"),
        ...
        WRITE_PARAMETER: {
            ...
            description:
                "Write a single parameter value. In response, a Parameter Write Response frame will be sent.",
            apiClass: 14,
            apiIndex: 0,
            arbId: 33896448,
            lengthBytes: 5,
            signals: {
                ...
                VALUE: {
                    ...
                    name: "Value",
                    description:
                        "The actual type of this data depends on the Parameter Type of the parameter in question.",
                    bitPosition: 8,
                    isBigEndian: false,
                    lengthBits: 32,
                    decodeScaleFactor: BigNumber("1"),
        ...
        PARAMETER_WRITE_RESPONSE: {
            ...
            description:
                "Response for a parameter write (including a write done as part of a dual-write).",
            apiClass: 14,
            apiIndex: 1,
            arbId: 33896512,
            lengthBytes: 7,
        ...
        GET_PARAMETER_RANGE_RESPONSE: {
            ...
            signals: {
                ...
                IS_MIN_VALUE: {
                    ...
                    name: "Is Min Value",
                    description:
                        "If true, the Value signal contains the minimum value, otherwise it contains the maximum value.",
                    bitPosition: 8,
                    isBigEndian: false,
                    lengthBits: 1,
                    decodeScaleFactor: BigNumber("1"),
