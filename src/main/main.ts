          ...
          click(_, window) {
            ...
            dialog
              .showSaveDialog(window, {
                ...
                defaultPath: "Advantage Scope " + new Date().toLocaleDateString().replaceAll("/", "-") + ".json",
                properties: ["createDirectory", "showOverwriteConfirmation", "dontAddToRecent"],
                ...
                if (files.filePaths.length > 0) {
                  ...
                  if (data.version !== currentVersion) {
                    let result = dialog.showMessageBoxSync(window, {
                      ...
                      detail:
                        "The layout file was generated by a different version of Advantage Scope. Compatability is not guaranteed.",
