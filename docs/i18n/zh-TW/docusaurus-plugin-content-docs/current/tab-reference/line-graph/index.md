...
<img src="/img/tab-reference/line-graph/line-graph-1.png" alt="折線圖示範" />
...
:::tip
選取時間與游標懸停時間之間的差值會作為覆蓋層顯示在圖表上，從而可以輕鬆測量時間範圍。
:::
...
<img src="/img/tab-reference/line-graph/line-graph-4.png" alt="編輯軸範圍" />
