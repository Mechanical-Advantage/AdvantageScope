...
انقر فوق `ملف` > `تنزيل السجلات...` لفتح نافذة التنزيل. تنزيل السجلات مدعوم على Systemcore و roboRIO. بمجرد الاتصال بالروبوت، يتم عرض السجلات المتاحة مع أحدثها في الأعلى. حدد ملف أو مجلد سجل واحد أو أكثر لتنزيله (انقر مع الضغط على shift لتحديد نطاق أو **cmd/ctrl + A** لتحديد الكل). ثم انقر فوق الرمز ↓ وحدد موقع الحفظ.
