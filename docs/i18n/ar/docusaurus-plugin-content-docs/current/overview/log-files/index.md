...
انقر فوق `ملف` > `تنزيل السجلات...` لفتح نافذة التنزيل. بمجرد الاتصال بالروبوت، يتم عرض السجلات المتاحة مع أحدثها في الأعلى. حدد ملف سجل واحد أو أكثر لتنزيله (انقر مع الضغط على shift لتحديد نطاق أو **cmd/ctrl + A** لتحديد الكل). ثم انقر فوق الرمز ↓ وحدد موقع الحفظ.
