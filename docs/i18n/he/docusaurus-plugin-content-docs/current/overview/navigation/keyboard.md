...
<tr><td>`Ctrl+Shift+N`</td><td>סגירת החלון הנוכחי</td></tr>
<tr><td>`Ctrl+Comma`</td><td>פתיחת חלון ההעדפות</td></tr>
<tr><td>`Ctrl+Period`</td><td>הפעלה/כיבוי של נראות סרגל הצד</td></tr>
...
**הקיצורים למטה משמשים ליצירת כרטיסיות חדשות במהירות:**

<table>
<tr>
<td>`Option+G`</td><td>[📉 גרף קווי](/tab-reference/line-graph)</td>
<td>`Option+V`</td><td>[🎬 וידאו](/tab-reference/video)</td>
</tr>
<tr>
...
<td>`Option+M`</td><td>[⚙️ מנגנון](/tab-reference/mechanism)</td>
</tr>
<tr>
<td>`Option+C`</td><td>[💬 מסוף](/tab-reference/console)</td>
<td>`Option+P`</td><td>[📍 נקודות](/tab-reference/points)</td>
</tr>
<tr>
<td>`Option+S`</td><td>[📊 סטטיסטיקה](/tab-reference/statistics)</td>
<td>`Option+I`</td><td>[🔍 מטא-דאטה](/tab-reference/metadata)</td>
</tr>
</table>
