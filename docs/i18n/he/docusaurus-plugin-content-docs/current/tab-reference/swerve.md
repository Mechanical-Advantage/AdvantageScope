...
כרטיסיית הסוורב מציגה את המצב של ארבעה מודולי סוורב, כולל וקטורי המהירות, מיקומי סרק, סיבוב הרובוט ומהירויות השלדה.
...
- **מהירויות מודולים:** סט של ארבעה מצבי מודולי סוורב, המוצגים כווקטורים בדיאגרמה.
...
ספריות רבות תומכות בפורמט struct, כולל WPILib ו-AdvantageKit. קוד הדוגמה למטה מציג כיצד לתעד מצבי מודולי סוורב ב-Java.
...
- **גודל מסגרת:** המרחקים בין מודולי הסוורב השמאליים-ימניים והקדמיים-אחוריים. משנה את יחס הגובה-רוחב של דיאגרמת הרובוט.
