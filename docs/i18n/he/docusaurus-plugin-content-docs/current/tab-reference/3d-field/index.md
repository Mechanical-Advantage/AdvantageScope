...
## אובייקטי אלמנט משחק {#game-piece-objects}

כל מגרש כולל סט של סוגי אובייקטי אלמנט משחק, המאפשרים רינדור של אלמנטי משחק בכל מיקום במגרש תוך שימוש בנתונים שפורסמו על ידי קוד הרובוט. למנגנון זה מגוון יישומים, כולל:

- ויזואליזציה של פעולות מסלולי אוטונומי בסימולציה באמצעות אנימציות פשוטות
- הצגת מיקומים מזוהים של אלמנטי משחק במגרש
- ציון המיקום שבו ממוקמים אלמנטי משחק בתוך רובוט
- צפייה במסלולי ירי בהתבסס על חישובי פיזיקה
...
מצב זה נועל את המצלמה מאחורי אחת מעמדות הנהגים בגובה עיניים טיפוסי. ניתן לבחור ידנית את העמדה לצפייה או לבחור "אוטומטי" כדי להשתמש בברית ובמספר העמדה המאוחסנים בנתוני הלוג.

:::warning
בחירה אוטומטית של מספר עמדה עשויה להיות לא מדויקת בעת צפייה בנתוני לוג שנוצרו על ידי AdvantageKit 2023 או גרסאות מוקדמות יותר.
:::
