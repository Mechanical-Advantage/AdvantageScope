...
<img src="/img/tab-reference/2d-field-1.png" alt="סקירה כללית של כרטיסיית מגרש 2D" />
...
## הוספת אובייקטים {#adding-objects}
...
<img src="/img/tab-reference/2d-field-2.png" alt="מגרש 2D עם אובייקטים" />
