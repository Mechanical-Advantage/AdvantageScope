...
כרטיסיית הווידאו מאפשרת להשוות את נתוני היומן לצד סרטון משחק שהוקלט בנפרד. הצעדים למטה מראים כיצד לטעון סרטון ולסנכרן אותו עם היומן.

## טעינת הווידאו {#loading-the-video}
...
## ניווט בווידאו {#navigating-the-video}

כאשר סרטון נטען לראשונה וטרם סונכרן עם נתוני היומן, בקרות הניגון עבור הווידאו והיומן נשארות עצמאיות. יש להשתמש בציר הזמן ובלחצנים בחלק התחתון הימני כדי לשלוט בניגון הווידאו. קיצורי המקלדת הבאים נתמכים גם כן:
...
רוב סרטוני המשחק מסונכרנים באופן אוטומטי עם היומן זמן קצר לאחר טעינת הפריימים של תקופת האוטונומי במשחק. אין צורך בפעולה כלשהי; אם הסנכרון מצליח, בקרות הווידאו יינעלו באופן אוטומטי (ראו "ניגון" למטה).
...
## סנכרון ידני {#manual-synchronization}

תחילה, יש להשתמש בבקרות הווידאו כדי לנווט למיקום מוכר במשחק כמו תחילת האוטונומי. לאחר מכן, יש לבחור את הזמן בקובץ היומן המתיישר עם הפריים הנוכחי של הווידאו.
...
לאחר הנעילה, ניגון הווידאו נשאר מיושר עם הזמן שנבחר ביומן. שימו לב כי ניגון שמע אינו נתמך מכיוון שהסרטון המקורי מומלץ לייצוג פריים-אחר-פריים לתמיכה בסנכרון היומן.
