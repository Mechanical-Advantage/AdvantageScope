...
מודל חייב להיכלל בתיקייה עם השם "model.glb". לאחר הפעלת כל הסיבובים, המגרש צריך להיות מופנה כאשר הברית האדומה משמאל. קובצי CAD חייבים להמיר ל-glTF; ראו [דף זה](gltf-convert) לפרטים. מודלי אביזר משחק עוקבים אחר מוסכמת מתן השמות "model_INDEX.glb" בהתבסס על הסדר שבו הם מופיעים במערך "gamePieces". AprilTags שמוצהרים כאן ממוקמים תמיד תוך שימוש במערכת צירים [מרכז/אדום](/more-features/coordinate-systems#centerred-systemcore), ללא קשר לאפשרויות תצורה אחרות.
