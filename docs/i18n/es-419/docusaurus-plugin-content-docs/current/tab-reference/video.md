...
Primero, usa los controles de video para navegar a una ubicación conocida en el partido, como el inicio de auto. Luego, selecciona el tiempo en el archivo de registro que se alinee con el fotograma actual del video.
