# Conversión de archivos Onshape y STEP a glTF {#converting-onshape-and-step-files-to-gltf}
...
## Conversión de Onshape a STEP {#converting-onshape-to-step}
...
## Conversión de STEP a glTF {#converting-step-to-gltf}
