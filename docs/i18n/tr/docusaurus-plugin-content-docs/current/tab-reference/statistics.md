...
Başlamak için bir alanı "Ölçümler" bölümüne sürükleyin. X düğmesini kullanarak bir alanı silin veya göz simgesine tıklayarak ya da alan adına çift tıklayarak geçici olarak gizleyin. Tüm alanları kaldırmak için eksen başlığının yanındaki çöp kutusuna ve ardından `Tümünü Temizle` seçeneğine tıklayın. Alanlar listede tıklanıp sürüklenerek yeniden düzenlenebilir.
...
- [**Standart Sapma:**](https://tr.wikipedia.org/wiki/Standart_sapma) Düşük değerin daha az varyasyonu belirttiği en yaygın istatistiksel varyasyon ölçümü. Normal dağılmış veriler için, verilerin yaklaşık %68'i ortalamanın bir standart sapması içinde kalır.
- [**Medyan Mutlak Sapma:**](https://en.wikipedia.org/wiki/Median_absolute_deviation) Verilerin medyanından mutlak sapmaların medyanı. Bu, standart sapmaya kıyasla aykırı değerlere karşı daha dayanıklı bir istatistiksel yayılım ölçümüdür.
- [**Çeyrekler Açıklığı:**](https://tr.wikipedia.org/wiki/%C3%87eyrekler_a%C3%A7%C4%B1kl%C4%B1%C4%9F%C4%B1) Üçüncü ve birinci çeyrekler (%75 yüzdelik dilim ve %25 yüzdelik dilim) arasındaki fark, aykırı değerlerden standart sapmaya göre daha az etkilenir.
