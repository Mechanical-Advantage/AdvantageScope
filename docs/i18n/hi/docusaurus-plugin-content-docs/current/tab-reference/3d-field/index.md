...
:::warning 2026-2027 FTC फील्ड
2026-2027 FTC फील्ड पर AprilTag लक्ष्य गतिशील हैं और AdvantageScope में स्थिर ऑब्जेक्ट्स के रूप में प्रदर्शित नहीं किए जा सकते हैं। 3D फील्ड पर उनके स्थानों को देखने के लिए, ऑब्जेक्ट प्रकार को **3.25 इंच** आकार के साथ **AprilTag** पर सेट करें और रोबोट कोड से गतिशील रूप से उनकी स्थितियों को लॉग करें।
:::
