...
डाउनलोड विंडो खोलने के लिए `फ़ाइल` > `लॉग्स डाउनलोड करें...` पर क्लिक करें। लॉग डाउनलोडिंग Systemcore और roboRIO पर समर्थित है। रोबोट से कनेक्ट होने के बाद, उपलब्ध लॉग्स शीर्ष पर नवीनतम के साथ दिखाए जाते हैं। डाउनलोड करने के लिए एक या अधिक लॉग फ़ाइलें या फ़ोल्डर्स चुनें (एक सीमा का चयन करने के लिए shift-क्लिक करें या सभी का चयन करने के लिए **cmd/ctrl + A**)। फिर ↓ प्रतीक पर क्लिक करें और एक सेव स्थान चुनें।
