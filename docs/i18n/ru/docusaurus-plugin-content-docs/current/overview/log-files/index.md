...
:::info
Если одновременно открыто несколько файлов, метки времени будут выровнены автоматически. Это позволяет легко сравнивать файлы логов из нескольких источников.
:::
