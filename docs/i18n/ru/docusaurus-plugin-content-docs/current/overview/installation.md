...
:::info
Каждая крупная версия AdvantageScope выпускается в январе перед стартом сезона FRC, а номер версии соответствует году (например, v26.0.0 была выпущена в январе 2026 года). Бета- и альфа-версии AdvantageScope могут быть доступны в течение месяцев, предшествующих каждому релизу, для команд, желающих поэкспериментировать с новыми функциями и оставить отзыв. **Командам, использующим эти предрелизные версии, следует ожидать проблем и ошибок, отсутствующих в стабильных релизах.**
:::
...
## Неофициальные дистрибутивы {#unofficial-distributions}
