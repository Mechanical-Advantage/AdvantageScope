...
<img src="/img/more-features/coordinate-system-center-red.png" alt="中心/红方坐标系" />

## 蓝方联盟墙 {#blue-wall}

原点位于蓝方联盟墙的最右侧角，+X 轴面向红方联盟墙，如下图所示。**这是 2023 至 2026 年 FRC 场地的默认坐标系。**

<img src="/img/more-features/coordinate-system-blue-wall.png" alt="蓝方墙坐标系" />
...
<img src="/img/more-features/coordinate-system-center-rotated.png" alt="中心/旋转坐标系" />
