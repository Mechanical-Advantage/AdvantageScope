...
<img src="/img/more-features/custom-assets/gltf-convert-3.png" alt="在 CAD Assistant 中打开 STEP 文件" />

3. 等待 STEP 文件导入。这可能需要几分钟时间。

4. 点击“保存”图标：

<img src="/img/more-features/custom-assets/gltf-convert-4.png" alt="点击“保存”图标" />

5. 选择保存位置，然后使用下拉菜单将导出格式切换为 "glb"：

<img src="/img/more-features/custom-assets/gltf-convert-5.png" alt="切换导出格式" />
...
<img src="/img/more-features/custom-assets/gltf-convert-7.png" alt="点击“保存”图标" />
