...
:::info
右键单击渲染的场地视图并点击“设置 FOV...”以调整环绕相机和驾驶站相机的视野 (FOV)。
:::
...
此模式将相机锁定在其中一个驾驶站后方的典型眼高位置。可以手动选择要查看的驾驶站，或者选择“自动”以使用日志数据中存储的联盟和驾驶站编号。

:::warning
查看由 AdvantageKit 2023 或更早版本生成的日志数据时，自动选择驾驶站编号可能会不准确。
:::
