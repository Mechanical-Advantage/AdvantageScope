...
- **校准：**
  ...
  - 选择 _原尺寸_ 以准确缩放比例可视化场地，并基于真实场地围挡进行定位。在 _蓝方联盟_ 和 _红方联盟_ 之间切换可控制使用场地的哪一侧进行校准，但在所有情况下都会可视化整个场地。
- **串流：**
...
- **显示场地：** 显示场地模型，包括场地围挡和特定游戏元素。自定义 [游戏元素对象](/tab-reference/3d-field#game-piece-objects) 始终显示。
