...
- **驾驶站日志 (.dslog 和 .dsevents)** - 由 [FRC Driver Station](https://docs.wpilib.org/en/stable/docs/software/driverstation/driver-station.html) 生成。打开任何一种日志类型时，AdvantageScope 都会自动搜索相应的日志文件。
...
<img src="/img/overview/log-files/open-file-1.png" alt="打开已保存的日志" />
...
<img src="/img/overview/log-files/open-file-2.png" alt="下载日志文件" height="350" />
