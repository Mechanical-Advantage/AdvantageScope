...
Para pesquisar um campo, comece a digitar na caixa de pesquisa. Um menu suspenso de campos será exibido, então o campo selecionado será destacado na barra lateral e rolado para visualização.
...
:::info
As guias podem ser reorganizadas clicando e arrastando, ou renomeadas clicando com o botão direito e selecionando `Renomear...`
:::

Os botões de navegação (verdes) na parte superior gerenciam as guias e controlam a reprodução.

- **Botão Mais:** Abre um menu suspenso para criar uma nova guia.
- **Botão Janela:** Cria uma nova janela destacável com a guia atual. Esse recurso pode ser usado para visualizar dados de múltiplas guias simultaneamente.
...
:::info
Clique e arraste na borda superior para redimensionar ou ocultar o painel de controle. Dê um duplo clique para alternar a visibilidade do painel de controle.
:::
