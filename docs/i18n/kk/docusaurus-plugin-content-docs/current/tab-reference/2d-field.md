...
## Камераны басқару элементтері {#camera-controls}

Масштабты үлкейту және кішірейту үшін алаңның үстінде жоғары және төмен айналдырыңыз. Алаң бойынша жылжу үшін басып сүйреңіз. Келесі опциялары бар камера мәзірін ашу үшін алаңның кез келген жерін оң жақпен басыңыз:

- **Құлпы ашылған**: Жылжу және масштабтау қолмен орындалады.
- **Роботқа құлыпталған**: Камера роботты бақылау үшін автоматты түрде жылжиды.
- **Робот пен айналуға құлыпталған**: Камера робот пен оның айналуын бақылау үшін автоматты түрде жылжиды және бұрылады.

Кез келген құлыпталған режимде камераны роботтан еркін жылжытуға болады. Басқару тақтасындағы бағдарлау түймелерін кез келген режимде камераны бұру үшін пайдалануға болады.
