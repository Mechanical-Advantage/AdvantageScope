...
## Démarrage de la connexion {#starting-the-connection}
...
## Visualisation des données en direct {#viewing-live-data}
...
### Ignorer les données en direct {#discard-live-data}
