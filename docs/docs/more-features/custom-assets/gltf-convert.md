# Converting Onshape & STEP Files to glTF {#converting-onshape-and-step-files-to-gltf}
...
## Converting Onshape to STEP {#converting-onshape-to-step}
...
## Converting STEP to glTF {#converting-step-to-gltf}
