...
- [**FRC Nix:**](https://github.com/frc4451/frc-nix) A set of FIRST-related Nix packages and declarative NixOS modules including AdvantageScope for use with the Nix package manager, and the NixOS Linux distribution.